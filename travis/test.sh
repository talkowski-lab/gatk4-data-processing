...
#excute wdl script
java -Dconfig.file=travis/resources/google-adc.conf -Dbackend.providers.JES.config.project=broad-dsde-outreach -Dbackend.providers.JES.config.root=gs://beri-test/ -jar cromwell-${cromwell_version}.jar run ${wdl} -i ${json}
